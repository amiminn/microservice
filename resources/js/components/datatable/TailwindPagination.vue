<template>
    ...
    >
        <nav
            v-bind="$attrs"
            class="isolate inline-flex -space-x-px rounded"
            aria-label="Pagination"
            v-if="slotProps.computed.total > slotProps.computed.perPage"
        >
            <button
                class="relative inline-flex items-center rounded-l border px-2 py-2 text-sm font-medium focus:z-20 disabled:opacity-50"
                :class="itemClasses"
            ...
            <button
                class="relative inline-flex items-center rounded-r border px-2 py-2 text-sm font-medium focus:z-20 disabled:opacity-50"
                :class="itemClasses"
...
export default {
    ...
    props: {
        ...
        activeClasses: {
            type: Array,
            default: () => ["bg-sky-800", "border-sky-800", "text-white"],
        },
    },
